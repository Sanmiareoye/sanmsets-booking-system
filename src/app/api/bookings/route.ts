...
export async function POST(request: Request) {
  try {
    ...
    const mailOptions = {
      ...
      <p>To finalise your booking, please pay your deposit of <strong><u>€10</u></strong> <a href="https://revolut.me/oyesan98km">here</a>, with your full name and appointment date as the reference.</p>
