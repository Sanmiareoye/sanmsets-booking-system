      ...
      <main className={styles.about}>
        <div className={styles.section__container}>
          <div className={styles.about__grid}>
            ...
            <ImageCard src="/images/about-2.jpg" alt="Luxury Nails" />
...
const AboutContent = () => (
  <div className={styles.about__content}>
    ...
    <p className={styles.section__description}>
      ...
      2019. Our journey from a humble start to generating over 10,000 euros in
      revenue speaks volumes about our commitment to excellence. Experience the
      extraordinary as we blend innovation with elegance to create stunning nail
      designs that reflect both sophistication and style. Discover the artistry
      that has rapidly grown and transformed, offering you a touch of luxury
